...
json_file = open('../../Miner-Training-Local-CodeSample/TrainedModels/DQNmodel_20200806-1744_ep10000.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
DQNAgent = model_from_json(loaded_model_json)
# load weights into new model
DQNAgent.load_weights("../../Miner-Training-Local-CodeSample/TrainedModels/DQNmodel_20200806-1744_ep10000.h5")
